...
(parcelRequire("dWyTn")).register(JSON.parse('{"2bXA3":"index.38e003d6.js","7v5Ne":"defaultAvatarBig.8103fa76.png","k6Tkz":"defaultAvatar.7103e1c8.png","67yDZ":"index.510ca453.css"}'));
...
const $acfbc1c54750817e$var$JSONHeaders = {
    "content-type": "application/json"
};
const $acfbc1c54750817e$var$authApiInstance = new (0, $d32ca8009394484b$export$5767f363d4830f89)("https://ya-praktikum.tech/api/v2/auth");
const $acfbc1c54750817e$export$39813f5a3cc2bc5a = {
    signIn: async (data)=>{
        const res = await $acfbc1c54750817e$var$authApiInstance.post("/signin", {
            includeCredentials: true,
            data: JSON.stringify(data),
            headers: $acfbc1c54750817e$var$JSONHeaders
        });
        if (res.status !== 200) return JSON.parse(res.responseText);
        return res;
    },
    signUp: async (data)=>{
        const res = await $acfbc1c54750817e$var$authApiInstance.post("/signup", {
            includeCredentials: true,
            data: JSON.stringify(data),
            headers: $acfbc1c54750817e$var$JSONHeaders
        });
    ...
    logout: async ()=>{
        ...
        const res = await $acfbc1c54750817e$var$authApiInstance.post("/logout", {
            includeCredentials: true,
            headers: {
    ...
    getUser: async ()=>{
        const res = await $acfbc1c54750817e$var$authApiInstance.get("/user", {
            includeCredentials: true,
            headers: {
                accept: "application/json"
            }
...
const $76ab1306601d6176$var$chatsApiInstance = new (0, $d32ca8009394484b$export$5767f363d4830f89)("https://ya-praktikum.tech/api/v2");
const $76ab1306601d6176$export$4cb3a1b274fdb0b1 = {
    getChats: async ()=>{
        const res = await $76ab1306601d6176$var$chatsApiInstance.get("/chats", {
            includeCredentials: true,
            headers: {
                accept: "application/json"
            }
    ...
    getChatByTitle: async (title)=>{
        const res = await $76ab1306601d6176$var$chatsApiInstance.get(`/chats?title=${title}`, {
            includeCredentials: true,
            headers: {
                accept: "application/json"
            }
    ...
    getChatUsers: async (chatId)=>{
        const res = await $76ab1306601d6176$var$chatsApiInstance.get(`/chats/${chatId}/users`, {
            includeCredentials: true,
            headers: {
                accept: "application/json"
            }
    ...
    createChat: async (data)=>{
        const res = await $76ab1306601d6176$var$chatsApiInstance.post("/chats", {
            includeCredentials: true,
            headers: {
                accept: "application/json",
                "content-type": "application/json"
    ...
    deleteChat: async (chatId)=>{
        const res = await $76ab1306601d6176$var$chatsApiInstance.delete("/chats", {
            includeCredentials: true,
            headers: {
                accept: "application/json",
                "content-type": "application/json"
    ...
    addUserToChat: async (userId, chatId)=>{
        const res = await $76ab1306601d6176$var$chatsApiInstance.put("/chats/users", {
            includeCredentials: true,
            headers: {
                accept: "application/json"
            },
    ...
    getToken: async (chatId)=>{
        const res = await $76ab1306601d6176$var$chatsApiInstance.post(`/chats/token/${chatId}`, {
            includeCredentials: true,
            headers: {
                accept: "application/json"
            }
    ...
    changeAvatar: async (data)=>{
        const res = await $76ab1306601d6176$var$chatsApiInstance.put("/chats/avatar", {
            includeCredentials: true,
            data: data
        });
...
const $30cf6208a9d6910a$var$JSONHeaders = {
    "content-type": "application/json"
};
const $30cf6208a9d6910a$var$userApiInstance = new (0, $d32ca8009394484b$export$5767f363d4830f89)("https://ya-praktikum.tech/api/v2/user");
const $30cf6208a9d6910a$export$19245f3241d03f1c = {
    changeValues: async (data)=>{
        const res = await $30cf6208a9d6910a$var$userApiInstance.put("/profile", {
            includeCredentials: true,
            data: JSON.stringify(data),
            headers: $30cf6208a9d6910a$var$JSONHeaders
        });
        if (res.status !== 200) return JSON.parse(res.responseText);
        return true;
    },
    changePassword: async (data)=>{
        const res = await $30cf6208a9d6910a$var$userApiInstance.put("/password", {
            includeCredentials: true,
            data: JSON.stringify(data),
            headers: $30cf6208a9d6910a$var$JSONHeaders
        });
    ...
    changeAvatar: async (data)=>{
        const res = await $30cf6208a9d6910a$var$userApiInstance.put("/profile/avatar", {
            includeCredentials: true,
            data: data
        });
        console.log(data, res);
    ...
    usersSearch: async (data)=>{
        const res = await $30cf6208a9d6910a$var$userApiInstance.post("/search", {
            includeCredentials: true,
            data: JSON.stringify(data),
            headers: $30cf6208a9d6910a$var$JSONHeaders
        });
...
(function(Screens) {
    ...
    Screens["ProfileChangeValues"] = "profileChangeValues";
...
const $5211e3debc8b89bb$var$map = {
    ...
    [$5211e3debc8b89bb$export$b714373eb9ab036b.ProfileChangeValues]: (0, $ca09a02b5bf7cf1e$export$728d8f7ba79ef181)
};
...
class $1d4d90f758478686$export$353f5b6fc5456de1 extends (0, $9654315c65fc281a$export$2e2bcd8739ae039) {
    ...
    constructor({ text: text , className: className , type: type = "button" , onClick: onClick  }){
        super({
            text: text,
            className: className,
            type: type,
...
class $626b24686b57d8cb$export$2e2bcd8739ae039 {
    ...
    constructor(url, user, chatId, token){
        this.user = user;
...
class $77063c1e0041fbfc$var$ChatMessages extends (0, $9654315c65fc281a$export$2e2bcd8739ae039) {
    ...
    webSocketUrl = "wss://ya-praktikum.tech/ws";
    constructor(props){
        super(props);
        this.setProps({
            ...props,
    ...
    componentDidMount() {
        if (this.props.currentChat) {
            this.props._socketTransport = new (0, $626b24686b57d8cb$export$2e2bcd8739ae039)(this.webSocketUrl, this.props.user, this.props.currentChat.id, this.props.currentChat.token);
