...
(parcelRequire("dWyTn")).register(JSON.parse('{"2bXA3":"index.d79658a7.js","7v5Ne":"defaultAvatarBig.8103fa76.png","k6Tkz":"defaultAvatar.7103e1c8.png","67yDZ":"index.f7cb3628.css"}'));
...
function $d86f0b59b1b0f0a9$export$cf7ee87ede64229c(router, store) {
    $d86f0b59b1b0f0a9$var$routes.forEach((route)=>{
        router.use(route.path, ()=>{
            ...
            if (isAuthorized && route.shouldGuest) store.dispatch({
