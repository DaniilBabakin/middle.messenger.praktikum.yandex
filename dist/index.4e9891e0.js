...
(parcelRequire("dWyTn")).register(JSON.parse('{"2bXA3":"index.4e9891e0.js","7v5Ne":"defaultAvatarBig.8103fa76.png","k6Tkz":"defaultAvatar.7103e1c8.png","67yDZ":"index.36d0808c.css"}'));
...
class $2533682e5a82ed9e$export$e7b0ac011bb776c6 {
    ...
    render() {
        if (!this._block) {
            ...
            (0, $6c8cc3259de8e17b$export$2e2bcd8739ae039)(this._block);
            return;
        }
        this._block.show();
        return this;
...
class $d86f0b59b1b0f0a9$export$55185c17a0fcbe46 {
    routes = [];
    history = window.history;
    _currentRoute = null;
    constructor(rootQuery){
        if ($d86f0b59b1b0f0a9$export$55185c17a0fcbe46.__instance) return $d86f0b59b1b0f0a9$export$55185c17a0fcbe46.__instance;
        this.routes = [];
        this.history = window.history;
        this._currentRoute = null;
        this._rootQuery = rootQuery;
        $d86f0b59b1b0f0a9$export$55185c17a0fcbe46.__instance = this;
    }
    use(pathname, block) {
        const route = new (0, $2533682e5a82ed9e$export$e7b0ac011bb776c6)(pathname, block, {
    ...
    getRoute(pathname) {
        ...
        if (!route) return this.routes.find((route)=>route.match((0, $88b977da1f221345$export$cd891b82501bb412).NotFound));
        return route;
    }
}
...
function $929a47de1db02a5f$var$isPlainObject(value) {
    return typeof value === "object" && value !== null && value.constructor === Object && Object.prototype.toString.call(value) === "[object Object]";
}
function $929a47de1db02a5f$var$isArray(value) {
    return Array.isArray(value);
}
function $929a47de1db02a5f$var$isArrayOrObject(value) {
    return $929a47de1db02a5f$var$isPlainObject(value) || $929a47de1db02a5f$var$isArray(value);
}
function $929a47de1db02a5f$export$248d38f6296296c5(lhs, rhs) {
    if (Object.keys(lhs).length !== Object.keys(rhs).length) return false;
    for (const [key, value] of Object.entries(lhs)){
        const rightValue = rhs[key];
        if ($929a47de1db02a5f$var$isArrayOrObject(value) && $929a47de1db02a5f$var$isArrayOrObject(rightValue)) {
            if ($929a47de1db02a5f$export$248d38f6296296c5(value, rightValue)) continue;
            return false;
        }
...
class $08966ababee588cf$var$LoginPage extends (0, $9654315c65fc281a$export$2e2bcd8739ae039) {
    constructor(props){
        ...
        this.setProps({
            ...
            onRedirectToSignUp: ()=>{
                (0, $18a724cc7e1bc394$export$5375cda95f0b0eb4).go((0, $88b977da1f221345$export$cd891b82501bb412).SignUp);
            },
            onSubmit: ()=>{
...
class $d4ff0f3b3dffba08$var$SignUpPage extends (0, $9654315c65fc281a$export$2e2bcd8739ae039) {
    constructor(props){
        ...
        this.setProps({
            ...
            onRedirectToLogin: ()=>{
                (0, $18a724cc7e1bc394$export$5375cda95f0b0eb4).go((0, $88b977da1f221345$export$cd891b82501bb412).Login);
            },
            onSubmit: ()=>{
...
class $2aa7b8afb325bb77$export$31641b61980e511f extends (0, $9654315c65fc281a$export$2e2bcd8739ae039) {
    constructor(){
        ...
        this.setProps({
            onClick: ()=>{
                (0, $18a724cc7e1bc394$export$5375cda95f0b0eb4).go((0, $88b977da1f221345$export$cd891b82501bb412).Chat);
            }
        });
    }
    render() {
...
const $33707c9830400a63$export$c996479cb76ab18b = async (dispatch, state, action)=>{
    ...
    dispatch({
        contacts: response.map((item)=>(0, $1fd43d9c112668c3$export$88dcd5c1adae8021)(item))
    });
};


class $ca09a02b5bf7cf1e$var$ProfileChangeValuesPage extends (0, $9654315c65fc281a$export$2e2bcd8739ae039) {
    constructor(props){
        super(props);
        this.setProps({
            ...props,
            ...
            onSubmit: ()=>{
                ...
                if (errorMessage.text) this.refs[errorMessage.inputName].refs[errorMessage.inputName.replace("Input", "Error")].setProps({
                    ...
                    console.log("Форма готова к отправке, данные: ", formData);
                    this.props.store.dispatch((0, $33707c9830400a63$export$2f2cc145bf0efa90), formData);
                }
            }
        });
...
const $ca09a02b5bf7cf1e$export$728d8f7ba79ef181 = (0, $34a895a60f8f63d4$export$369b6b2b30582e8e)((0, $4cb14a8771ecdce6$export$c605750379d8bc00)((0, $77eeb8d2c47f9696$export$186e7271a5553fd7)($ca09a02b5bf7cf1e$var$ProfileChangeValuesPage)));
...
class $0fdc6d5eb8a63666$var$ChatContacts extends (0, $9654315c65fc281a$export$2e2bcd8739ae039) {
...
function $0fdc6d5eb8a63666$var$mapUserToProps(state) {
    return {
        contacts: state.contacts
    };
}
const $0fdc6d5eb8a63666$export$d295da43c2cd8369 = (0, $e5275a62ea5f5771$export$d9e5202a22de6581)((0, $8b2c807fc48699cd$export$9d43a29426bbda85)($0fdc6d5eb8a63666$var$ChatContacts));
...
class $43afbd1842942e06$export$96c211badc9d5a98 extends (0, $9654315c65fc281a$export$2e2bcd8739ae039) {
    ...
    constructor(props){
        super({
            ...
            events: {
                click: ()=>{
                    (0, $18a724cc7e1bc394$export$5375cda95f0b0eb4).go((0, $88b977da1f221345$export$cd891b82501bb412).Profile);
                }
            }
        });
    }
    ...
    constructor(props){
        super({
            ...
            events: {
                click: (e)=>{
                    const inputEl = e.target;
                    (0, $76ab1306601d6176$export$4cb3a1b274fdb0b1).getToken(props.chat.id).then((token)=>{
                        window.store.dispatch({
                            currentChat: {
                                ...props.chat,
                                token: token
...
const $18a724cc7e1bc394$export$5375cda95f0b0eb4 = new (0, $d86f0b59b1b0f0a9$export$55185c17a0fcbe46)(".app");
document.addEventListener("DOMContentLoaded", ()=>{
    const router = new (0, $d86f0b59b1b0f0a9$export$55185c17a0fcbe46)(".app");
    const store = new (0, $70e35aadc369705a$export$390f32400eaf98c9)((0, $2aa4e78f17d7163a$export$49d5fc8cba920a0));
    window.router = router;
    window.store = store;
    router.use((0, $88b977da1f221345$export$cd891b82501bb412).Login, (0, $08966ababee588cf$export$f14c0e3f98d164c0)).use((0, $88b977da1f221345$export$cd891b82501bb412).SignUp, (0, $d4ff0f3b3dffba08$export$265471dcab9022d3)).use((0, $88b977da1f221345$export$cd891b82501bb412).Profile, (0, $b50a023a0c8ea3f6$export$120c0e7b1bef3ec7)).use((0, $88b977da1f221345$export$cd891b82501bb412).ProfileSettings, (0, $ca09a02b5bf7cf1e$export$728d8f7ba79ef181)).use((0, $88b977da1f221345$export$cd891b82501bb412).ChangePassword, (0, $4c0ae98585ede1ef$export$3816d479340d863a)).use((0, $88b977da1f221345$export$cd891b82501bb412).Chat, (0, $5f43d472c2e48f2e$export$ceaf35c25d4b1fe2)).use((0, $88b977da1f221345$export$cd891b82501bb412).NotFound, (0, $2aa7b8afb325bb77$export$31641b61980e511f)).start();
